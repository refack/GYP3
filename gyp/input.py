...
def LoadBuildFileIncludesIntoDict(subdict, subdict_path, data, aux_data, includes=None):
  ...
  for include in includes_list:
    ...
    gyp.common.DebugOutput(gyp.DEBUG_INCLUDES, "Loading Included File: '%s'", include)
...
def LoadTargetBuildFile(build_file_path, data, aux_data, variables, includes, depth, load_dependencies):
  ...
  gyp.common.DebugOutput(gyp.DEBUG_INCLUDES, "Loading Target Build File '%s'", build_file_path)
...
def ExpandVariables(input, phase, variables, build_file):
  ...
  for match_group in matches:
    ...
    gyp.common.DebugOutput(gyp.DEBUG_VARIABLES, "Matches: %r", match)
    ...
    if file_list:
      ...
      if cached_value is None:
        gyp.common.DebugOutput(gyp.DEBUG_VARIABLES, "Executing command '%s' in directory '%s'", contents, build_file_dir)
        ...
        gyp.common.DebugOutput(gyp.DEBUG_VARIABLES, "Had cache value for command '%s' in directory '%s'", contents, build_file_dir)
  ...
  if output == input:
    gyp.common.DebugOutput(gyp.DEBUG_VARIABLES, "Found only identity matches on %r, avoiding infinite recursion.", output)
  else:
    ...
    gyp.common.DebugOutput(gyp.DEBUG_VARIABLES, "Found output %r, recursing.", output)
